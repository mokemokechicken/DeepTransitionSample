/* Generator: http://goodparts.d.yumemi.jp/generator#StateMachineGenerator--426e5a8b82c48c2c77b3c3d9672587ea6f2e12e5
 * ex: set ro:
 * DO NOT EDIT.
...
@implementation TransitionCenterState
...
- (void)change:(TransitionModelFSM*)context :(id)params;
{
    [self Default:context];
}
...
- (void)request:(TransitionModelFSM*)context :(id)destination;
{
    [self Default:context];
}
...
{
    TransitionCenter *ctxt = [context owner];
...
{
    return (TransitionCenterState*)_state;
}
...
- (void)change:(id)params;
{
    [[self state] change:self :params];
}
